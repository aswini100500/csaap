...
function Commission() {
  ...
  return (
    <div className="flex-1 bg-gray-50 p-4 rounded-2xl">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Commission Report</h1>
        <p className="text-gray-500 font-bold text-sm">
          View and manage commission payments for your team.
        </p>
      </div>
              ...
              {loading ? (
                <tr>
                  <td colSpan={columns.length} className="px-4 py-8 text-center">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-500 font-medium text-sm">Loading commission data...</p>
                    </div>
                  </td>
                </tr>
              ) : (
                <tr>
                  <td colSpan={columns.length} className="px-4 py-8 text-center">
                    ...
                    <p className="text-gray-500 font-medium text-sm">No commissions found</p>
                  </td>
                </tr>
              )}
            </tbody>
