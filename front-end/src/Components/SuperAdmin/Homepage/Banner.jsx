...
const BannerList = ({ onAddBanner, banners, searchTerm, setSearchTerm, isLoading }) => {
  return (
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-4 bg-gray-50 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button className="flex items-center gap-1 text-gray-600 hover:text-purple-700 disabled:opacity-50" disabled>
              Previous
            </button>
            
            <div className="flex gap-1">
              <button className="w-8 h-8 rounded-lg bg-purple-700 text-white">1</button>
            </div>
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Banner Upload</h1>
        <button
          onClick={onViewList}
