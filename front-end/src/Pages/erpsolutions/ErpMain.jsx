...
export default function ErpMain() {
  ...
  return (
    <div className="w-full bg-[#00695C]">
      ...
      Our ERP software simplifies your operations with smart inventory management,
       seamless accounting, and hassle-free GST compliance. Generate invoices in seconds,
        track inventory in real time, reconcile bank transactions effortlessly, and file GST returns with ease. Save time,
       reduce errors, and focus on growing your business while we handle the complexities.
          </p>
