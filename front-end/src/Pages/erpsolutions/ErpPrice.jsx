  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full bg-[#00695C] py-7 px-6 text-center">
       ...
       This Stock & Inventory Management module, designed to simplify stock tracking,
       optimize warehouse operations, and eliminate manual errors.
       Our intelligent system provides real-time visibility of your inventory across multiple locations,
       ensuring you never run out of stock or overstock again.
        </p>
