  ...
  return (
    <div className="w-full bg-blue-50 py-16">
      <h2 className="text-4xl md:text-4xl font-bold text-center mb-12">
        Modern & Unique Features to 
        <p>Track your Field Force Efficiently</p>
        </h2>
        ...
        <div className="flex flex-col md:flex-row items-center md:gap-12">
          ...
          <div className="md:w-1/2 w-full">
            <h3 className="text-2xl md:text-3xl font-bold mb-4">
              ...
              <span className="text-blue-800">of GST</span>
            </h3>
          ...
          <div className="md:w-1/2 w-full flex justify-center mt-8 md:mt-0">
            <img
              src="https://margcompusoft.com/images/sfa-fea-img-01.png"
              alt="Basic of GST"
        ...
        <div className="flex flex-col md:flex-row-reverse items-center md:gap-12">
          ...
          <div className="md:w-1/2 w-full">
            ...
            <p className="text-gray-700 mb-6">
              ...
              2017 and with that <span className="font-semibold text-blue-600">GST Registration</span> became an important aspect to
          ...
          <div className="md:w-1/2 w-full flex justify-center mt-8 md:mt-0">
            <img
              src="https://margcompusoft.com/images/sfa-fea-img-02.png"
