...
export default function HeroPage() {
  ...
  return (
    <div className="w-full bg-[#083a86]">
      {/* Container */}
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 py-12 md:py-20">
        ...
        <div className="md:w-2/3 text-white">
          <h1 className="text-3xl md:text-5xl font-bold leading-snug">
            All-in-One Invoicing Software to Manage Billing Easily
          </h1>
          <p className="mt-4 text-base md:text-lg text-gray-200 max-w-xl">
            Marg® ERP is a GST-ready inventory & accounting software that helps
            you generate invoices easily, manage your accounts, reconcile bank
            transactions, track inventory accurately, generate 1000’s of reports
            & MIS, and file GST returns effortlessly
          </p>
        ...
        <div className="md:w-1/3 w-full mt-10 md:mt-0 flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-[#002e69] text-white py-2 rounded-lg text-lg font-semibold mt-3 hover:bg-[#004d40] transition"
              >
                BOOK NOW
              </button>
            </form>
      ...
      <div className="pt-12 bg-white">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 py-10">
          ...
          <div className=" rounded-xl shadow-xl border border-gray-100 p-6 flex flex-col items-center">
            <MdOutlineMonitor className="text-5xl text-blue-900 mb-3" />
          ...
          <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-6 flex flex-col items-center">
            <MdOutlineCurrencyRupee className="text-5xl text-blue-900 mb-3" />
          ...
          {/* 3 */}
          <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-6 flex flex-col items-center">
            <MdOutlineMedication className="text-5xl text-blue-900 mb-3" />
          ...
          {/* 4 */}
          <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-6 flex flex-col items-center">
            <MdOutlinePublic className="text-5xl text-blue-900 mb-3" />
            <div className="text-xl font-bold">
              1 Million<sup>+</sup>
            </div>
            <span className="text-gray-500 text-sm mt-1 text-center">
          ...
          {/* 5 */}
          <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-6 flex flex-col items-center">
            <MdOutlineBusinessCenter className="text-5xl text-blue-900 mb-3" />
            <div className="text-xl font-bold">
              850<sup>+</sup>
            </div>
            <span className="text-gray-500 text-sm mt-1 text-center">
          ...
          {/* 6 */}
          <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-6 flex flex-col items-center">
            <MdOutlinePeopleOutline className="text-5xl text-blue-900 mb-3" />
            <div className="text-xl font-bold">
              8500<sup>+</sup>
            </div>
            <span className="text-gray-500 text-sm mt-1 text-center">
