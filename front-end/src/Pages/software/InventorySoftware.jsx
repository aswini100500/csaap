  ...
  const features = [
    {
      ...
      title: "Real-time stock tracking and updates",
      description:
        "Provides a live view of current inventory levels across all locations, automatically updating with every sale or purchase.",
      accent: "from-teal-500 to-teal-300",
    },
    {
      icon: <MdOutlineInventory2 className="text-4xl text-white" />,
      title: "Multi-warehouse and multi-location management",
      description:
        "Allows you to manage and track inventory seamlessly across multiple storage facilities or retail outlets from a single platform.",
      accent: "from-indigo-500 to-indigo-300",
    },
    {
      icon: <MdOutlineAccountBalanceWallet className="text-4xl text-white" />,
      title: "Batch, serial number, and expiry tracking",
      description:
        "Monovers individual batches and serial numbers for precise traceability and sends alerts for items nearing their expiration date.",
      accent: "from-yellow-500 to-yellow-300",
    },
    {
      icon: <MdOutlinePointOfSale className="text-4xl text-white" />,
      title: "Automated reordering and stock alerts",
      description:
        "Automatically generates purchase orders when stock hits a predefined minimum level, preventing stockouts and overstocking.",
      accent: "from-pink-500 to-pink-300",
    },
    {
      icon: <MdOutlineLocalShipping className="text-4xl text-white" />,
      title: "Barcode and QR code integration",
      description:
        "Enables quick and accurate scanning of items for fast sales, receipt, and stocktaking, drastically reducing manual data entry errors.",
      accent: "from-green-500 to-green-300",
    },
    {
      icon: <MdOutlineBarChart className="text-4xl text-white" />,
      title: "Purchase and sales linkage",
      description:
        "Automatically updates inventory levels by syncing stock data directly with your purchase orders and sales invoices.",
      accent: "from-purple-500 to-purple-300",
    },
    {
      icon: <MdOutlinePointOfSale className="text-4xl text-white" />,
      title: "Category and product-wise inventory reports",
      description:
        "Generates detailed reports filtered by product categories or individual items to analyze stock movement and performance.",
      accent: "from-blue-500 to-blue-300",
    },
    {
      icon: <MdOutlineAccountBalanceWallet className="text-4xl text-white" />,
      title: "Inventory valuation and cost management",
      description:
        "Calculates the total value of your current stock using methods like FIFO and provides insights into inventory carrying costs.",
      accent: "from-purple-500 to-purple-300",
    },
    {
      icon: <MdOutlineReceiptLong className="text-4xl text-white" />,
      title: "Stock transfer and adjustment tools",
      description:
        "Facilitates easy movement of goods between locations and allows for manual correction of stock levels during audits or counts.",
      accent: "from-pink-500 to-pink-300",
    },
  ];
    ...
    <div className="w-full">
      <div className="bg-[#00695C] py-16">
        <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">
          What are the features of Inventory Software?
        </h2>
    ...
    <div className="w-full">
      ...
      <div className="w-full bg-[#00695C] py-7 px-6 text-center">
        <h2 className="text-2xl md:text-4xl font-bold text-white leading-snug mb-4">
          ...
          <span className="text-yellow-400">Inventory Software?</span>
        </h2>
        <p className="text-gray-200 max-w-3xl mx-auto text-sm md:text-base mb-8">
     The inventory module promotes transparency, enhances operational efficiency, and enables faster, data-driven decision-making, helping you lower costs while boosting overall productivity.
        </p>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 py-12 md:py-20">
        ...
        <div className="md:w-2/3 text-white">
          <h1 className="text-3xl md:text-5xl font-bold leading-snug">
           Smart Inventory Management for Growing Businesses with{" "}
            <span className="text-yellow-200">
             CSAAP ERP
            </span>{" "}
          </h1>
          <p className="mt-4 text-base md:text-lg text-gray-200 max-w-xl">
            Gain complete control over your stock and warehouse operations with Inventory Software. Designed to streamline inventory tracking, optimize stock levels, and minimize losses, it helps businesses of all sizes from single stores to multi-warehouse setups automate every stage of the inventory process, from procurement to delivery, with real-time accuracy and insights.
Equipped with advanced analytics, barcode integration, and intelligent reordering alerts, CSAAP ensures you never face stockouts or overstocking issues. The inventory module promotes transparency, enhances operational efficiency, and enables faster, data-driven decision-making, helping you lower costs while boosting overall productivity.
