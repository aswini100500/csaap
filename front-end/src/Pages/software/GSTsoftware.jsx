  ...
  const features = [
    {
      ...
      title: "Smart & GST-compliant invoicing",
      description:
        "Creates invoices that automatically adhere to all GST regulations and formats, minimizing errors and ensuring legal compliance.",
      accent: "from-teal-500 to-teal-300",
    },
    {
      icon: <MdOutlineInventory2 className="text-4xl text-white" />,
      title: "Automated billing and recurring invoices",
      description:
        "Saves time by automatically generating and sending invoices for regular customers and subscription-based services.",
    ...
    },
    {
      ...
      description:
        "Effortlessly handles transactions in various currencies and consolidates financial data from multiple business locations",
      accent: "from-yellow-500 to-yellow-300",
    },
    {
      icon: <MdOutlinePointOfSale className="text-4xl text-white" />,
      title: "Real-time payment tracking and reminders",
      description:
        "Monovers outstanding payments live and automatically sends reminders to customers to ensure timely collections.",
      accent: "from-pink-500 to-pink-300",
    },
    {
      icon: <MdOutlineLocalShipping className="text-4xl text-white" />,
      title: "Integrated accounting and expense management",
      description:
        "Streamlines bookkeeping by seamlessly recording all invoices and expenses directly into the general ledger.",
      accent: "from-green-500 to-green-300",
    },
    {
      icon: <MdOutlineBarChart className="text-4xl text-white" />,
      title: "E-invoicing and e-way bill generation",
      description:
        "Directly generates authenticated e-invoices for the GST portal and creates e-way bills for goods transportation.",
    ...
    },
    {
      ...
      description:
        "Allows you to design professional invoices that reflect your brand identity and include all necessary details.",
      accent: "from-blue-500 to-blue-300",
    },
    {
      icon: <MdOutlineAccountBalanceWallet className="text-4xl text-white" />,
      title: "Customer & vendor database management",
      description:
        "Maintains a centralized directory of all your business contacts for quick access and efficient transaction processing.",
      accent: "from-purple-500 to-purple-300",
    },
    {
      icon: <MdOutlineReceiptLong className="text-4xl text-white" />,
      title: "Role-based access and approval controls",
      description:
        "Enhances security by granting employees access only to relevant functions and setting up approval workflows for transactions.",
      accent: "from-pink-500 to-pink-300",
    },
  ];
    ...
    <div className="w-full">
      ...
      <div className="w-full bg-[#00695C] py-7 px-6 text-center">
        <h2 className="text-2xl md:text-4xl font-bold text-white leading-snug mb-4">
          ...
          <span className="text-yellow-400">Billing Software?</span>
        </h2>
        <p className="text-gray-200 max-w-3xl mx-auto text-sm md:text-base mb-8">
     Our billing module helps you generate GST-compliant invoices,
       manage customers and vendors, track due payments,
      and monitor your business finances in real-time. With advanced automation,
       you can reduce manual effort, prevent errors, and improve cash flow management efficiently.
        </p>
        ...
        <div className="py-3 flex justify-center">
          <button className="px-7 py-3 bg-teal-600 text-white text-lg font-semibold rounded-lg shadow hover:bg-teal-700 transition-all">
            Book Demo
             ...
             <button onClick={handleSubmit} className="px-6 py-2 ml-5 bg-teal-600 text-white font-semibold rounded-md hover:bg-teal-800 transition">
                add to cart
            </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 py-12 md:py-20">
        ...
        <div className="md:w-2/3 text-white">
          <h1 className="text-3xl md:text-5xl font-bold leading-snug">
            Simplify Tax Compliance with{" "}
            <span className="text-yellow-200">
             CSAAP ERP
            </span>{" "}
          </h1>
          <p className="mt-4 text-base md:text-lg text-gray-200 max-w-xl">
            Managing GST doesn’t have to be complex. CSAAP’s GST Software is designed to make tax filing, invoicing, and compliance effortless for businesses of all sizes. With automated workflows, real-time validations, and integrated reporting, our software ensures 100% accuracy and on-time submissions — so you can focus on growth, not paperwork.
       Whether you are a small business, trader, or enterprise, CSAAP’s intelligent GST solution streamlines all your tax operations in one centralized platform. From invoice generation to return filing, it ensures end-to-end compliance with the latest GST norms and government regulations.
Our GST module syncs seamlessly with Accounting, Inventory, and Billing, providing a complete view of your financials while minimizing errors and saving time.
