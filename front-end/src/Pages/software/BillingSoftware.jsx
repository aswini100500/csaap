      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 py-12 md:py-20">
        ...
        <div className="md:w-2/3 text-white">
          ...
          <p className="mt-4 text-base md:text-lg text-gray-200 max-w-xl">
            Enhance your business with our Billing Software, a smart, automated solution designed to make billing, invoicing, and payment management effortless. Whether you’re a small business or a growing enterprise, CSAAP ensures accuracy, speed, and compliance all from a single, easy-to-use dashboard.
Our billing module helps you generate GST-compliant invoices, manage customers and vendors, track due payments, and monitor your business finances in real-time. With advanced automation, you can reduce manual effort, prevent errors, and improve cash flow management efficiently.
Stay ahead with seamless integration across accounting, inventory, and sales modules giving you complete financial control and transparency at every step.
