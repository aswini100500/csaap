...
export default function ABanner() {
  ...
  return (
    <div>
    <div className="w-full bg-[#024eb3]">
      {/* Container */}
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 py-12 md:py-20">
        ...
        <div className="md:w-2/3 text-white">
          <h1 className="text-3xl md:text-5xl font-bold leading-snug">
            India’s Best Accounting Software for Small Businesses
          </h1>

          {/* Features */}
          <ul className="mt-8 space-y-3 text-lg">
            {[
              "Automate invoicing, payments, and expense tracking—error-free and efficient.",
              "Manage multiple accounts from one dashboard with real-time updates.",
              "Stay compliant with built-in GST support and tax-ready features.",
              "Instant Reports & Insights for faster & smarter decisions.",
              "Cloud-Based & Secure software and seamless collaboration across teams.",
            ].map((item, i) => (
        ...
        <div className="md:w-1/3 w-full mt-10 md:mt-0 flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-[#024eb3] text-white py-2 rounded-lg text-lg font-semibold mt-3 hover:bg-[#004d40] transition"
              >
                BOOK NOW
              </button>
            </form>
