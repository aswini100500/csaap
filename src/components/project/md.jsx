...
const updateUnit = (unitId, field, value) => {
                      ...
                      <div className="space-y-2">
                        {block.floors.map((floor) => (
                          <div key={floor.id} className="bg-white rounded border border-slate-200 overflow-hidden">
                            {/* Floor Header */}
                            <div
                              className="flex items-center justify-between p-2 bg-gradient-to-r from-blue-50 to-white border-b border-slate-200 cursor-pointer hover:bg-blue-50 transition-colors"
  ...
  const renderUnits = () => (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      {/* Units List */}
      <div className="lg:col-span-1 bg-white/80 backdrop-blur-xl p-4 rounded-xl border border-white/60 shadow-sm flex flex-col h-[calc(100vh-10rem)] min-h-[500px]">
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-2 md:p-4 font-sans">
